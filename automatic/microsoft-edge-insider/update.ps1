...
function global:au_GetLatest {
    ...
    $low = ($download_page.AllElements | Where-Object data-download-enterpriseid -match "Beta32MSI" |Select-Object -first 1 -ExpandProperty data-download-url)
    $high = ($download_page.AllElements | Where-Object data-download-enterpriseid -match "Beta64MSI" |Select-Object -first 1 -ExpandProperty data-download-url)
    
    #$version = $url -replace '.exe', '' -split '_' | Select-Object -Last 1
    #$url32 = 'https://github.com' + $url[0]
    #$url64 = 'https://github.com' + $url[1]

    $Latest = @{URL32 = $low; URL64 = $high; Version = $version; }
    return $Latest
}
update
